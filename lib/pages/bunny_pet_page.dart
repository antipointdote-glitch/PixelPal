...
class BunnyPetPage extends StatefulWidget {
  final PetModel pet;
  const BunnyPetPage({super.key, required this.pet});

  @override
  State<BunnyPetPage> createState() => _BunnyPetPageState();
}

class _BunnyPetPageState extends State<BunnyPetPage> {
  final TextEditingController _textController = TextEditingController();
  
  String _dialogueText = "Do not lie to me.";
  bool isLoading = false;

  // Theme: Pink/Toxic
  static const Color colBackground = Color(0xFFF8BBD0); 
            ...
            Expanded(
              ...
              child: Container(
                ...
                child: Container(
                  ...
                  child: Center(
                    // GIF WITH GAPLESS PLAYBACK
                    child: Image.asset(
                      'assets/images/bunny.gif', 
                      height: 120, 
                      fit: BoxFit.contain,
                      gaplessPlayback: true, // REQUIRED
                    ),
                  ),
                ),
              ),

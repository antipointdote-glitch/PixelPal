...
class StonePetPage extends StatefulWidget {
  final PetModel pet;
  const StonePetPage({super.key, required this.pet});

  @override
  State<StonePetPage> createState() => _StonePetPageState();
}

class _StonePetPageState extends State<StonePetPage> {
  ...
  // Theme: Stone Grey
  static const Color colBackground = Color(0xFFCFD8DC); 
            ...
            Expanded(
              ...
              child: Container(
                ...
                child: Container(
                  ...
                  child: Center(
                    // STONE ASSET
                    child: Image.asset('assets/images/stone.png', height: 120, fit: BoxFit.contain),
                  ),
                ),
              ),
            ),
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  child: Container(
                    height: 48, width: 48,
                    decoration: BoxDecoration(
                      color: const Color(0xFFB0BEC5), // grey
                      border: Border.all(color: Colors.black, width: 3),
                      borderRadius: BorderRadius.circular(2),
